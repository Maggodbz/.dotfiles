...
return {
  ...
  keys = {
    ...
    {key="h",  mods="SHIFT", action=wezterm.action.AdjustPaneSize{"Left", 3}},
    {key="l", mods="SHIFT", action=wezterm.action.AdjustPaneSize{"Right", 3}},
    {key="k",    mods="SHIFT", action=wezterm.action.AdjustPaneSize{"Up", 2}},
    {key="j",  mods="SHIFT", action=wezterm.action.AdjustPaneSize{"Down", 2}},

    -- 🧭 Navigate with Alt + Arrows
