...
_DEFAULT_DIR = Path.home() / ".local/share/kaya/kokoro"


def _resolve_model_dir() -> Path:
    env = os.environ.get("KAYA_VOICE_DIR")
...
DEFAULT_VOICE = os.environ.get("KAYA_VOICE", "af_heart")
LANG = os.environ.get("KAYA_VOICE_LANG", "en-us")
