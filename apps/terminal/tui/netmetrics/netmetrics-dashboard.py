...
def listen_for_keys(
    ...
    """Read single keypresses in a daemon thread and dispatch them.

    Falls back to just waiting on `quit_event` when stdin isn't a usable tty.
    """
